...
void Copy_Odd_Number(int Arr[100], int Arr_Dest[100], int Source_Length, int& Dest_Length)
{
...
int main()
{
	...
	Copy_Odd_Number(Arr_1, Arr_2, Arr1_Length, Arr2_Length);
	...
	cout << "\nArray 2 Odd Number: " << Arr2_Length << endl;
